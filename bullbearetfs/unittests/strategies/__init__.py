"""
  This package contains unittests for the various Strategies component.
  These are tests that that check the functionality of the backend for Various Strategies
