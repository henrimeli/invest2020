import datetime
import logging,xmlrunner,unittest
from django.test import TestCase
# Import Models
from bullbearetfs.market.models import WebsiteContactPage
from bullbearetfs.indicator.models import CHOICES_INDICATOR_CLASS, EquityIndicator

"""
  This module contains unittests for the Dashboard component.
  These are tests that check the functionality of the backend for the Dashboard
...
def test_dashboard_dummy(request):
  pass
