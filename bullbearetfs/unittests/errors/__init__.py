"""
  This package contains unittests for the Custom Error Handling/Definition component.
  These are tests that check the functionality of the backend for the Error Handling
