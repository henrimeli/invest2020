"""
  This package contains unittests for the Foundational component.
  These are tests that that check the functionality of the backend for Foundational Component
