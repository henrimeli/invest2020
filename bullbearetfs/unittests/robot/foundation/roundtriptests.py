...
"""
  ...
  -TODO: Risk Exposure after divesting one side. To be implemented as version 2.0 
...
class RoundtripBasicOneBuyTestCase(TestCase):
  ...
  def setUpTestData(self):
    ...
    sentiment_0 = EquityAndMarketSentiment.objects.create(pair_robot=robot1,influences_acquisition=False,circuit_breaker=False,
