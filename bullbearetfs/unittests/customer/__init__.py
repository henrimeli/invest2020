"""
  This package contains unittests for the Customer Management component.
  These are tests that check the functionality of the backend for the Customer Management
